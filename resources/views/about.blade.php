...
<body>
    ...
    <main class="about-main">
        ...
        {{-- Slider de trois images --}}
        <section class="slider-sec">
            <div id="splide" class="splide">
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide n-flex n-center about-slider">
                            <img class="slider-back"
                                src="{{asset('/')}}img/slider/slider1.jfif">
                            <img class="slider-cont"
                                src="{{asset('/')}}img/slider/slider1.jfif"></li>
                        <li class="splide__slide n-flex n-center about-slider">
                            <img class="slider-back"
                                src="{{asset('/')}}img/slider/slider2.jpg">
                            <img class="slider-cont"
                                src="{{asset('/')}}img/slider/slider2.jpg"></li>
                        <li class="splide__slide n-flex n-center about-slider">
                            <img class="slider-back"
                                src="{{asset('/')}}img/slider/slider3.jpg">
                            <img class="slider-cont"
                                src="{{asset('/')}}img/slider/slider3.jpg"></li>
                    </ul>
                </div>
            </div>
        </section>
